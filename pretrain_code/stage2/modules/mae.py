...
from models.modules.pos_embed import *

class MAEViTEncoder(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone - encoder part """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=1024,
                 ...
                 pretrained=True, checkpoint='mae', **kwargs):
        super().__init__()
        self.vision_width = embed_dim
        # --------------------------------------------------------------------------
    ...
    def forward(self, imgs, mask_ratio=0.75):
        ...
        return x, mask, ids_restore  # latent, mask, ids_restore


class MAEViTDecoder(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone - decoder branch """
    def __init__(self, patch_size=16, in_chans=3, embed_dim=1024, mlp_ratio=4., norm_layer=nn.LayerNorm,
...
# officially implementation from MAE paper
