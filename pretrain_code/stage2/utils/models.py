...
def load_pretrained(config, model, name):
    if name == 'swin':
        load_dir = os.path.join(config.root_dir, 'models/swin_transformer/swin_tiny_patch4_window7_224.pth')
    else:
